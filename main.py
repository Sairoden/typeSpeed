...
def time():
    ...
    if timer>0:
        ...
        rr= messagebox.askretrycancel('Notification','You wanna Play Again?')
        if rr==True:
            score=0
            miss=0
            timer=60
...
root.iconbitmap('calculator01.ico')
...
startlabel=Label(root,text="Begin the game!",font=('airal',30,
